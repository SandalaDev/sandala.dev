...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  // Step 2: Update the data from 'posts' to 'projects'
  await db.execute(sql`
    UPDATE "pages_blocks_archive" 
    SET "relation_to" = 'projects' 
    WHERE "relation_to" = 'posts';
  `)
  ...
  await db.execute(sql`
   ALTER TYPE "public"."enum_posts_technologies" RENAME TO "enum_projects_technologies";
  ALTER TYPE "public"."enum_posts_project_date_month" RENAME TO "enum_projects_project_date_month";
  ALTER TYPE "public"."enum_posts_status" RENAME TO "enum_projects_status";
  ALTER TYPE "public"."enum__posts_v_version_technologies" RENAME TO "enum__projects_v_version_technologies";
  ALTER TYPE "public"."enum__posts_v_version_project_date_month" RENAME TO "enum__projects_v_version_project_date_month";
  ALTER TYPE "public"."enum__posts_v_version_status" RENAME TO "enum__projects_v_version_status";
  ALTER TABLE "posts_technologies" RENAME TO "projects_technologies";
  ALTER TABLE "posts" RENAME TO "projects";
  ALTER TABLE "posts_rels" RENAME TO "projects_rels";
  ALTER TABLE "_posts_v_version_technologies" RENAME TO "_projects_v_version_technologies";
  ALTER TABLE "_posts_v" RENAME TO "_projects_v";
  ALTER TABLE "_posts_v_rels" RENAME TO "_projects_v_rels";
  ALTER TABLE "pages_rels" RENAME COLUMN "posts_id" TO "projects_id";
  ALTER TABLE "_pages_v_rels" RENAME COLUMN "posts_id" TO "projects_id";
  ALTER TABLE "redirects_rels" RENAME COLUMN "posts_id" TO "projects_id";
  ALTER TABLE "search_rels" RENAME COLUMN "posts_id" TO "projects_id";
  ALTER TABLE "payload_locked_documents_rels" RENAME COLUMN "posts_id" TO "projects_id";
  ALTER TABLE "header_rels" RENAME COLUMN "posts_id" TO "projects_id";
  ALTER TABLE "footer_rels" RENAME COLUMN "posts_id" TO "projects_id";
  ...
  ALTER TABLE "projects_technologies" DROP CONSTRAINT "posts_technologies_parent_fk";
  
  ALTER TABLE "projects" DROP CONSTRAINT "posts_hero_image_id_media_id_fk";
  
  ALTER TABLE "projects" DROP CONSTRAINT "posts_meta_image_id_media_id_fk";
  
  ALTER TABLE "projects_rels" DROP CONSTRAINT "posts_rels_parent_fk";
  
  ALTER TABLE "projects_rels" DROP CONSTRAINT "posts_rels_categories_fk";
  
  ALTER TABLE "_projects_v_version_technologies" DROP CONSTRAINT "_posts_v_version_technologies_parent_fk";
  
  ALTER TABLE "_projects_v" DROP CONSTRAINT "_posts_v_parent_id_posts_id_fk";
  
  ALTER TABLE "_projects_v" DROP CONSTRAINT "_posts_v_version_hero_image_id_media_id_fk";
  
  ALTER TABLE "_projects_v" DROP CONSTRAINT "_posts_v_version_meta_image_id_media_id_fk";
  
  ALTER TABLE "_projects_v_rels" DROP CONSTRAINT "_posts_v_rels_parent_fk";
  
  ALTER TABLE "_projects_v_rels" DROP CONSTRAINT "_posts_v_rels_categories_fk";
  ...
  DROP INDEX "posts_technologies_order_idx";
  DROP INDEX "posts_technologies_parent_idx";
  ...
  DROP INDEX "_posts_v_version_technologies_order_idx";
  DROP INDEX "_posts_v_version_technologies_parent_idx";
